...
module.exports = Task.extend({
  ...
  runTasks: function(options) {
    ...
    if (taskRunner) {
      ...
      taskRunner.project = this.project;
      taskRunner.tasks = this.tasks;
      taskRunner.ui = this.ui;
      taskRunner.analytics = this.analytics;

      return taskRunner.run(requireLocal(taskRunner.module), options);
    } else {
